...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
    ...
    switch(tok){
     908:	83 7d f4 3c          	cmpl   $0x3c,-0xc(%ebp)
     90c:	74 0e                	je     91c <parseredirs+0x5f>
     90e:	83 7d f4 3e          	cmpl   $0x3e,-0xc(%ebp)
     912:	74 27                	je     93b <parseredirs+0x7e>
     914:	83 7d f4 2b          	cmpl   $0x2b,-0xc(%ebp)
