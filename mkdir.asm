...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3f9:	0f b6 91 94 0a 00 00 	movzbl 0xa94(%ecx),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 532:	75 25                	jne    559 <printf+0xff>
          s = "(null)";
 534:	c7 45 f4 43 08 00 00 	movl   $0x843,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 5fa:	a1 b0 0a 00 00       	mov    0xab0,%eax
 ...
 6c5:	a3 b0 0a 00 00       	mov    %eax,0xab0
}
 6ca:	90                   	nop
 6cb:	c9                   	leave  
 6cc:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 723:	83 c4 10             	add    $0x10,%esp
  return freep;
 726:	a1 b0 0a 00 00       	mov    0xab0,%eax
}
 72b:	c9                   	leave  
 72c:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 73f:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 742:	a1 b0 0a 00 00       	mov    0xab0,%eax
 747:	89 45 f0             	mov    %eax,-0x10(%ebp)
 74a:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 74e:	75 23                	jne    773 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 750:	c7 45 f0 a8 0a 00 00 	movl   $0xaa8,-0x10(%ebp)
 757:	8b 45 f0             	mov    -0x10(%ebp),%eax
 75a:	a3 b0 0a 00 00       	mov    %eax,0xab0
 75f:	a1 b0 0a 00 00       	mov    0xab0,%eax
 764:	a3 a8 0a 00 00       	mov    %eax,0xaa8
    base.s.size = 0;
 769:	c7 05 ac 0a 00 00 00 	movl   $0x0,0xaac
 770:	00 00 00 
  }
 ...
 7c6:	a3 b0 0a 00 00       	mov    %eax,0xab0
      return (void*)(p + 1);
 ...
 7d1:	eb 3b                	jmp    80e <malloc+0xe1>
    ...
    if(p == freep)
 7d3:	a1 b0 0a 00 00       	mov    0xab0,%eax
